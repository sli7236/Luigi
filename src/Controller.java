...
public class Controller extends Application{
    ...
    public void start(Stage stage) {
        ...
        for(int i = 0; i<data.size();i++){
            ...
            table.getColumns().add(new Data(current.getPlayerName(), current.getScore(), current.getEnemyShipHits(), current.getEnemyShipsSunk(), current.getPlayerShipHits(), current.getPlayerShipsSunk()));
        }
